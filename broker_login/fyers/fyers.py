...
from broker_login.fyers.token import Token

class Fyers:
    def __init__(self):
        self.__username = fyers["username"]
        self.__totp_key = fyers["totp_key"]
        self.__pin = fyers["pin"]
        self.__client_id = fyers["client_id"]
        self.__secret_key = fyers["secret_key"]
        self.__redirect_uri = fyers["redirect_uri"]
